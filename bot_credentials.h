...
#define BOT_ACCOUNT_NAME "your account name goes here"

/* Twitch OAUTH TOKEN (https://twitchapps.com/tmi/)*/
#define TWITCH_OAUTH_TOKEN "oauth:some secret key"

/* Channel you want to run the bot in */
#define CONNECT_CHANNEL_NAME "where you want to run your bot"
